package com.dxsoft.houseApp.receiver;
...
import com.dxsoft.houseApp.activity.MainActivity;
...
public class PushReceiver extends PushMessageReceiver {
	 ...
	 */
	@Override
	public void onBind(final Context context, int errorCode, String appid, String userId, final String channelId, String requestId) {
		...
		if (errorCode == 0) {
			...
			new AsyncTask<Void, Void, Void>() {
				...
				protected Void doInBackground(Void... arg0) {
					String userSid = HouseSharePreference.getStringData(context, HouseConfig.KEY_USERSID);
					Parameter parameter = new Parameter();
					parameter.setUserSid(Integer.valueOf(userSid));
					parameter.setChannelId(channelId);
					try {
						HttpHelper.requestData(HouseConfig.METHOD_BINDPUSH, C.Url, parameter);
					} catch (IOException e) {
						e.printStackTrace();
					}
					return null;
